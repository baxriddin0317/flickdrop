  ...
  return (
    <div className="bg-brand-dark rounded-3xl overflow-hidden w-full">
      <div className="px-6 py-2.5 h-[66px] flex items-center justify-between border-b border-brand-gray-2">
        <h3 className="hidden lg:block text-brand-gray-2 text-ellipsis font-medium text-lg line-clamp-1">{title}</h3>
        {items.length > 0 && (
          <div className="flex items-stretch flex-row-reverse lg:flex-row w-full lg:w-auto gap-2 ">
            <div className="w-1/2 lg:w-[184px] h-11 rounded-[10px] bg-brand-neutral-4 border border-white/10 shadow-[0_0_14.721px_0_rgba(0,0,0,0.06)_inset] px-3 py-1.5 flex flex-col justify-between">
            ...
            <div className="relative overflow-hidden w-1/2 lg:w-44 xl:w-[254px] h-11 rounded-[10px] bg-brand-neutral-4 border border-white/10 shadow-[0_0_14.721px_0_rgba(0,0,0,0.06)_inset] ">

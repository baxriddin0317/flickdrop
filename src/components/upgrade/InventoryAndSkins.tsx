  ...
  return (
    <div className="bg-brand-dark rounded-3xl overflow-hidden w-full">
      <div className="px-6 py-2.5 h-[66px] flex items-center justify-between border-b border-brand-gray-2">
        ...
        {items.length > 0 && (
          <div className="flex items-center gap-2 ">
            <div className="w-[184px] h-11 rounded-[10px] bg-brand-neutral-4 border border-white/10 shadow-[0_0_14.721px_0_rgba(0,0,0,0.06)_inset] px-3 py-1.5 flex flex-col justify-between">
            ...
            <div className="relative overflow-hidden w-[254px] h-11 rounded-[10px] bg-brand-neutral-4 border border-white/10 shadow-[0_0_14.721px_0_rgba(0,0,0,0.06)_inset] ">
      ...
      <div className="h-[533px] relative p-6 pr-3 z-10">
        ...
        {items.length > 0 ? (
          <div className="overflow-y-scroll scroll-style grid grid-cols-5 gap-1 min-h-full h-full pr-3">
            {items.map((item) => (

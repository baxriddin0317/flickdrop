...
import { HeroLeft, HeroProgress, HeroRight } from './HeroProgress'
...
const UpgradeHero = () => {
  ...
  return (
    <div className="max-w-[1728px] h-[800px] mx-auto relative z-0">
      {state === 'win' ? (
        <Image className='absolute w-[1846px] h-[1231px] left-0 -top-72 -z-10' src={'/imgs/upgrade-win.png'} alt='' width={1846} height={1231} />
      ) : state=='lose' ? (
        <Image className='absolute w-[1846px] h-[1231px] left-0 -top-72 -z-10' src={'/imgs/upgrade-lose.png'} alt='' width={1846} height={1231} />
      ) : (
        <Image className='absolute w-[1846px] h-[1231px] left-0 -top-72 -z-10' src={'/imgs/upgrade-default.png'} alt='' width={1846} height={1231} />
      )}
      <div className='relative z-10 pt-6'>
        ...
        <div className='flex items-center justify-center py-6'>
          <div className='relative translate-x-[75px]'>
            <HeroLeft />
          </div>
          <div className='relative z-20 translate-y-[13px]'>
            <HeroProgress />
          </div>
          <div className='relative -translate-x-[72px] -translate-y-[3px]'>
            <HeroRight />
          </div>
        </div>
